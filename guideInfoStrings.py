...
__type_display_text = "Please type a message or text to add it to the output PDF file."
...
__aboutPage_PDFHash_title__ = "PDF Hash"
__aboutPage_PDFHash_text__ = "< coming soon... >\n"
